...
#ggsave(here("figs", "MainFigs", "Figure5_SuitabilitySp.svg"), bg = "white",fig5, width = 40, height =18, dpi = 300)
```
...
combined_df <- readRDS(here::here("rdsFiles", "TempCopernicus25-40m.RDS"))
