...
#ggsave(here("figs", "SuppFigs", "FigS4_combTempFig.png"), bg = "white",combFig, units = "cm", height =28, width =38, dpi = 300)
...
#ggsave(here("figs", "SuppFigs", "FigS6_BS-MOT-TEMP.png"), bg = "white", combIntFig, units="cm", height =16, width =54, dpi = 300)
...
#ggsave(here("figs", "SuppFigs", "FigS7_flowTraitDiff.png"), combEmmeanPlot, units = "cm", width = 36, height = 18, dpi = 300, bg = "white")



```

## Figure S8 - Species-specific suitability trends
...
#ggsave(here("figs", "SuppFigs", "FigS8_slope_lollipop.png"), fig_slope_lollipop, width = 14, height = 16, dpi = 300)
