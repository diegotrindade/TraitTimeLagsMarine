...
combined_df <- readRDS(here::here("rdsFiles", "TempCopernicus25-40m.RDS")) # rds file to use temperature in the models
...
#ggsave(here("figs", "MainFigs", "MapTempChange.png"), final_plot, units =  "cm", width = 40, height = 30, dpi = 300)
```
...
# ggsave(here("figs", "MainFigs", "Fig_Traits_Combined.png"), plot = catPlotSuitTrait, bg = "white", width = 10, height = 6, dpi = 300)
...
#ggsave(here("figs", "MainFigs", "Fig2communityLevelPl.png"),catPlotObsDDComm, bg = "white", width = 24, height = 14, units = "cm", dpi = 300)
...
#ggsave(here("figs", "MainFigs", "Figure5_SuitabilitySp.png"), bg = "white",fig5, width = 40, height =18, dpi = 300)
```
...
fig_temp
#ggsave(here("figs", "SuppFigs", "FigTemp.png"), bg = "white",fig_temp, units = "cm", height =20, width =34, dpi = 300)
...
# Fit nlme::lme model with AR1 for each dataset
